...
const createStaffViaRPC = async (email, password, name, phone = '') => {
          ...
          <Dialog open={open} onOpenChange={(v) => { setOpen(v); setFormError(""); setFormSuccess(""); }}>
            ...
            <DialogContent className="max-w-md">
              ...
              <div className="space-y-4 py-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="staff-phone">Contact Number <span className="text-muted-foreground font-normal">(optional)</span></Label>
                  <Input
                    id="staff-phone"
                    type="tel"
                    ...
                    <td className="p-4">
                      <div className="flex flex-col gap-1.5 items-start">
                        ...
                        <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                          <span className={cn("h-2 w-2 rounded-full", onlineUsers.has(u.id) ? "bg-green-500" : "bg-slate-300")} />
