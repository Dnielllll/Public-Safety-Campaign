      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-display text-2xl font-bold flex items-center gap-2">
            <BarChart3 className="h-6 w-6 text-primary" /> System Reports
          </h1>
          <p className="text-muted-foreground text-sm">Performance of all campaigns across the entire system.</p>
        </div>
