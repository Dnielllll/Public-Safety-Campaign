  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      if (campaigns && campaigns.length > 0) {
        ...
        setData([
          { campaign: "Fire Safety Tips", engagement: 450, fullTitle: "Fire Safety Tips", category: "fire_safety" },
          { campaign: "Dengue Prevention", engagement: 380, fullTitle: "Dengue Prevention", category: "health" },
          { campaign: "Road Safety", engagement: 320, fullTitle: "Road Safety Campaign", category: "road_safety" },
          { campaign: "Emergency Prep", engagement: 290, fullTitle: "Emergency Preparedness", category: "emergency" },
          { campaign: "Clean-Up Drive", engagement: 250, fullTitle: "Community Clean-Up Drive", category: "environment" },
        ]);
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Performance of all published campaigns.</p>
        </div>
